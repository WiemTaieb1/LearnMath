...
export const EmailCircle = (props: SVGProps<SVGSVGElement>) =>
    <svg
        {...props} width="24" height="24" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 122.88 122.88">
